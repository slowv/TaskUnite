package com.vbtn.taskunite.config;

import com.vbtn.taskunite.security.*;
...
//            .addFilterBefore(corsFilter, CsrfFilter.class)
        ...
        .and()
            .headers()
//            .contentSecurityPolicy("default-src 'self' data:; frame-src 'self' data:; script-src 'self' 'unsafe-inline' 'unsafe-eval' https://storage.googleapis.com; style-src 'self' 'unsafe-inline'; img-src * 'self' data: https:; font-src 'self' data:")
//        .and()
