...
export class UserExtendComponent implements OnInit, OnDestroy {
  ...
  loadAll() {
    this.userExtendService
      ...
      .subscribe(
        (res: HttpResponse<IUserExtend[]>) => this.paginateUserExtends(res.body, res.headers),
  ...
  registerChangeInUserExtends() {
    this.eventSubscriber = this.eventManager.subscribe('userExtendListModification', response => this.loadAll());
  }
