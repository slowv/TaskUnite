...
export class TaskerComponent implements OnInit, OnDestroy {
  ...
  loadAll() {
    this.taskerService
      ...
      .subscribe((res: HttpResponse<ITasker[]>) => this.paginateTaskers(res.body, res.headers));
  }
  ...
  trackId(index: number, item: ITasker) {
    return item.id;
  }
  ...
  protected paginateTaskers(data: ITasker[], headers: HttpHeaders) {
