...
import { UserInformationComponent } from 'app/entities/user-information/user-information.component';
...
describe('Component Tests', () => {
  describe('UserInformation Management Component', () => {
    let comp: UserInformationComponent;
    ...
    beforeEach(() => {
      TestBed.configureTestingModule({
        ...
        .overrideTemplate(UserInformationComponent, '')
        .compileComponents();
