...
import { PaymentInformationComponent } from 'app/entities/payment-information/payment-information.component';
...
describe('Component Tests', () => {
  describe('PaymentInformation Management Component', () => {
    let comp: PaymentInformationComponent;
    ...
    beforeEach(() => {
      TestBed.configureTestingModule({
        ...
        .overrideTemplate(PaymentInformationComponent, '')
        .compileComponents();
    ...
    it('Should call load all on init', () => {
      ...
      spyOn(service, 'query').and.returnValue(
        of(
          new HttpResponse({
            body: [new PaymentInformation(123)],
            headers
          })
        )
      );
      ...
      expect(comp.paymentInformations[0]).toEqual(jasmine.objectContaining({ id: 123 }));
    });
