...
import { AdminTransactionComponent } from 'app/entities/admin-transaction/admin-transaction.component';
...
describe('Component Tests', () => {
  describe('AdminTransaction Management Component', () => {
    let comp: AdminTransactionComponent;
    ...
    beforeEach(() => {
      TestBed.configureTestingModule({
        ...
        .overrideTemplate(AdminTransactionComponent, '')
        .compileComponents();
    ...
    it('Should call load all on init', () => {
      ...
      expect(comp.adminTransactions[0]).toEqual(jasmine.objectContaining({ id: 123 }));
    });
