...
import { UserExtendComponent } from 'app/entities/user-extend/user-extend.component';
...
describe('Component Tests', () => {
  describe('UserExtend Management Component', () => {
    let comp: UserExtendComponent;
    ...
    beforeEach(() => {
      TestBed.configureTestingModule({
        ...
        .overrideTemplate(UserExtendComponent, '')
        .compileComponents();
    ...
    it('Should call load all on init', () => {
      ...
      expect(comp.userExtends[0]).toEqual(jasmine.objectContaining({ id: 123 }));
    });
