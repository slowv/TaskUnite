...
import { TaskCategoryComponent } from 'app/entities/task-category/task-category.component';
...
describe('Component Tests', () => {
  describe('TaskCategory Management Component', () => {
    ...
    it('Should call load all on init', () => {
      ...
      expect(comp.taskCategories[0]).toEqual(jasmine.objectContaining({ id: 123 }));
    });
