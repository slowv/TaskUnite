...
import { AdminProfitComponent } from 'app/entities/admin-profit/admin-profit.component';
...
describe('Component Tests', () => {
  describe('AdminProfit Management Component', () => {
    let comp: AdminProfitComponent;
    ...
    beforeEach(() => {
      TestBed.configureTestingModule({
        ...
        .overrideTemplate(AdminProfitComponent, '')
        .compileComponents();
    ...
    it('Should call load all on init', () => {
      ...
      expect(comp.adminProfits[0]).toEqual(jasmine.objectContaining({ id: 123 }));
    });
