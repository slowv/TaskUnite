...
import org.t1708e.taskunite.repository.TaskRepository;
import org.t1708e.taskunite.service.TaskService;
import org.t1708e.taskunite.service.dto.TaskDTO;
import org.t1708e.taskunite.service.mapper.TaskMapper;
...
public class TaskResourceIT {
    ...
    public void createTask() throws Exception {
        ...
        assertThat(testTask.getDeletedAt()).isEqualTo(DEFAULT_DELETED_AT);
    }
    ...
    public void updateTask() throws Exception {
        ...
        assertThat(testTask.getDeletedAt()).isEqualTo(UPDATED_DELETED_AT);
    }
